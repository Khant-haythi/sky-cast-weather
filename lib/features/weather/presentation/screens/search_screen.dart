...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Future<void> _initializeDefaultLocation() async {
    ...
    if (cityName.isNotEmpty) {
      // ✅ FIX 1: Update 'localWeatherProvider' so the card stays static
      // and doesn't change when you search for other cities.
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ FIX 1 (UI Side): We watch the local provider for the card
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (cityName.isNotEmpty) {
                        // Keep updating localWeatherProvider if this button is clicked
                        ref.read(localWeatherProvider.notifier).fetchWeather(cityName);
                        _controller.clear();
                      }
                    },
